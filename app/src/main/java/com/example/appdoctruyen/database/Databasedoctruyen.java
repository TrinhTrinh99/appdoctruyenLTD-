...
//    Biến lưa bảng tạo bảng tài khoản
...
//    Tạo phân quyền admin và người dùng

    private String SQLQuery2 = "INSERT INTO TaiKhoan VAlUES (null,'admin','admin','admin@gmail.com',2)";
    private String SQLQuery3 = "INSERT INTO TaiKhoan VAlUES (null,'diemmy','diemmy','diemmy@gmail.com',1)";
//    insert dữ liệu truyện
...
//        thực hiện câu lệnh truy vấn không trả về kết quả
    ...
    // Tạo cơ sở dữ liệu thành công gồm tài khoản và truyện
//    phuong thức lấy tất cả tài khoản
    public Cursor getData(){
        SQLiteDatabase db = this.getReadableDatabase();
         SQLiteDatabase dbwirte = this.getWritableDatabase();
...
//    phương thức add tài khoản vào database
    public void  AddTaiKhoan(TaiKhoan taiKhoan){
        ...
        // Thực hiện insert thông qua content values
